...
It is hard to tell if the means are statistically significantly different, **High** category only shows, that disribution there is skewed. So we will apply analysis of variance on **ExpendCat** to test:
