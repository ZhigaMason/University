...
-   **Independence** of observations (is true)
...
The red approximation line slightly increases with time, so maybe we still have homoscedastic data. We can verify it with Breusch-Pagan test
...
Observation with number $47$ lies closest to the border of Cook’s distance, but it doesn’t fall outside of the dashed line. This means **there are no influential points** in our regression model.
