...
The number of prisoners is much higher in Eastern countries. As a result distribution is skewed left with a mean $120$, a median $104$ and a standard deviation of $51$ prisoners per hundred thousands inhabitants.
...
**Daily Internet Usage** has a normal-looking distribution with a heart of online activity in Denmark. Surprisingly, internet usage has a strong positive linear correlation with **Average Salary**.
...
TODO: I dont know what does it mean, like should we do $\chi^2$ test or smth
...
-   *lyhin_preference.L* and *lyhin_preference.Q*: These linear and quadratic contrasts for political preference do not significantly predict wage levels, suggesting **no clear effect on average annual wages**.
...
The Cook's distance diagnostic flags Portugal (22) as one of the most influential observations in the model.\
...
-   **Outside the Cook's Distance Boundary (dashed lines):** Portugal crosses the 0.5 Cook's distance contour, confirming it has a disproportionately large influence on the fitted coefficients.
...
We can be confident that coefficient estimates and standard errors aren't being inflated by collinearity among these variables. (All scaled GVIFs are far below common concern thresholds).
