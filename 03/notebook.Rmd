...
```{r}
model <- lm(values ~ distance_to_voronezh + lyhin_preference + prisoners_per_100K + nace_r2_sector + daily_internet_usage_pc, data = data)
vif(model, type='predictor')
```

gotta do smth about categorical variables
```{r}
```
