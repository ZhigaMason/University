...
```
There are several samples on the far right, which can be thought of as outliers, most of data stay between $0$ and $1000$.
...
Individual plots follwo accumulated values shapes, but they have shfted peaks, so it resembles bell curve, so they acn be normal.
